...
; Versions:
;       V1.0: March 26, 2026 - Writing The Code 
;	V1.1: March 31, 2026 - Revised Version with Loop Delay

;---------------------

#include ".\MyConfigFile.inc"

#include "C:\Users\User\MPLABXProjects\Counter_Design.X\myConfigFile.inc"
#include <xc.inc>
